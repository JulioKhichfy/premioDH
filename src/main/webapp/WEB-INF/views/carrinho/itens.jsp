...
<title>Livros de Java, SOA, Android, iPhone, Ruby on Rails emuito mais - Casa do Código</title>
			...
			<tbody>
				<c:forEach items="${carrinhoCompras.itens }" var="item">
					<tr>
						...
						<td class="item-title">${item.trabalho.titulo}</td>
						...
						<td class="remove-item">
    						<form action="${s:mvcUrl('CCC#remover').arg(0, item.trabalho.id).arg(1,item.tipoPreco).build() }" method="post">
