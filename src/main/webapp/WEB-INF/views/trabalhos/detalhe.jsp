  ...
  <header id="layout-header">
	...
	<article id="${trabalho.id}">
		  <header id="product-highlight" class="clearfix">
		    <div id="product-overview" class="container">
		      ...
		      <h1 class="product-title">${trabalho.titulo}</h1>
		    ...
		    <p class="book-description">
		    	${trabalho.descricao}
		    	${trabalho.tipoModalidadeTrabalho}
		    </p>
		    </div>
		  </header>
	  ...
	  <form action='<c:url value="/carrinho/add" />' method="post" class="container">
	    <ul id="variants" class="clearfix">
	    	  <li class="buy-option">
	            ...
	            <small class="product-author">${trabalho.tipoModalidadeTrabalho}</small>
	          </li>           
	    </ul>
	    <c:forEach items="${trabalho.precos}" var="preco">
		  <li class="buy-option">
		    <input type="radio" name="tipo" class="variant-radio" id="tipo" value="${preco.tipoPreco}"  checked="checked"  />
		    <label  class="variant-label">
		      ${preco.tipoPreco}
		    </label>
	    ...
	    <input type="hidden" value="${trabalho.id}" name="trabalhoId" />
	...
	<div class="container">
	  ...
	  <section class="data product-detail">
	    ...
	    <p>Número de páginas: <span>${trabalho.paginas}</span></p>
	    <p></p>
	    <p>Data de publicação: ${trabalho.dataLancamento} </p>
