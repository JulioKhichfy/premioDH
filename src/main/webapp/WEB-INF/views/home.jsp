...
<head>
		...
		<c:url value="/resources/css_details" var="cssPathDetails" />
		...
		<link href="${cssPathDetails}/cssbase-min.css" rel="stylesheet" type="text/css" media="all" />
		<link href="${cssPathDetails}/fonts.css" rel="stylesheet" type="text/css" media="all" />
		<link href="${cssPathDetails}/fontello-ie7.css" rel="stylesheet" type="text/css" media="all" />
		<link href="${cssPathDetails}/fontello-embedded.css" rel="stylesheet" type="text/css" media="all" />
		<link href="${cssPathDetails}/fontello.css" rel="stylesheet" type="text/css" media="all" />
		<link href="${cssPathDetails}/style.css" rel="stylesheet" type="text/css" media="all" />
		<link href="${cssPathDetails}/layout-colors.css" rel="stylesheet" type="text/css" media="all" />
		<link href="${cssPathDetails}/responsive-style.css" rel="stylesheet" type="text/css" media="all" />
		<link href="${cssPathDetails}/guia-do-programador-style.css" rel="stylesheet" type="text/css"  media="all"  />
	    <link href="${cssPathDetails}/produtos.css" rel="stylesheet" type="text/css"  media="all"  />
		<link href="${cssPathDetails}/book-collection.css" rel="stylesheet" type="text/css" media="all" />
		...
		<title>Livros de Java, SOA, Android, iPhone, Ruby on Rails e</title>
</head>
<body>
  ...
  <header id="layout-header">
	...
	<section id="index-section" class="container middle">
		...
		<ul class="clearfix book-collection">
			...
			<a href="${s:mvcUrl('TC#detalhe').arg(0, trabalho.id).build()}" class="block clearfix">
            <h2 class="product-title">${trabalho.titulo}</h2>
	            <img width="143"
	                height="202"
